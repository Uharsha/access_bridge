...
const TTIDescription = () => {
  ...
  return (
    <>
      ...
      <div className="progress-bar" id="progressBar"></div><canvas id="stars"></canvas>
      ...
      {showIntroFly && flyPhase !== "done" && (
        <div id="introFlyText" className={`intro-fly-text ${flyPhase === "moving" ? "moving" : ""}`}>
          Technical Training Institute, PBMA
        </div>
      )}
      <div className="container tti-home-container">
